...
public class WebIATWS extends WebSocketListener {
	...
	private static final String appid = "xxxxxxx"; //在控制台-我的应用获取
	private static final String apiSecret = "xxxxxxx"; //在控制台-我的应用-语音听写（流式版）获取
	private static final String apiKey = "xxxxxxx"; //在控制台-我的应用-语音听写（流式版）获取
